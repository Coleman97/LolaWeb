...
<%
	try{
		...
		ResultSet rs2 = st.executeQuery("Select * from product where ID = 17");
		while(rs2.next()){
%>
...
<body>
	...
	<!-- -----Single Product -->
<%
ResultSet rs = st.executeQuery("Select * from product where ID = 17");
while(rs.next()){
%>
			...
			<div class="col-2">
				...
				<div class="small-img-row">
					<div class="small-img-col">
						<img style="height:115px" src="<%=rs.getString(3)%>" alt="" class="small-img">
					</div>
					<div class="small-img-col">
