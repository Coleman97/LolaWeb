			...
			<div class="row">
				...
				<div class="col-2">
					<div class="form-container">
						<div class="form-btn">
							<span onclick="login()">Login</span> <span onclick="register()">SignUp</span>
							<hr id="indicator">
						</div>
						...
						<form id="LoginForm" action="loginAction.jsp" method="post">
							...
							<a href="ForgotPassword.jsp" style="color: blue;">Forgot
								Password?</a>
						</form>

						<form name="myform" id="RegForm" action="SignUpAction.jsp"
							method="post">
