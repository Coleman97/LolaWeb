...
<%
	try{
		...
		ResultSet rs2 = st.executeQuery("Select * from product where ID = 15");
		while(rs2.next()){
%>
...
<body>
	...
	<!-- -----Single Product -->
<%
ResultSet rs = st.executeQuery("Select * from product where ID = 15");
while(rs.next()){
%>
...
%>
	...
	<div class="small-container">
		<div class="row">
			<div class="col-4">
				<a href="Lola Love me dress one.jsp"> <img
					src="images/Lola love me dress shirt1.jpeg" alt="">
					<h4>
						<b>Lola Love Me Dress One</b>
					</h4></a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
				</div>
			...
			<div class="col-4">
				<a href="lola off shoulder maxi dress.jsp"> <img
			...
			<div class="col-4">
				<a href="Lola love me dress two.jsp"> <img
					src="images/Lola love me dress shirt 2.jpeg" alt="">
					<h4>
						<b>Lola Love Me Dress Two </b>
					</h4></a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
				</div>
			...
			<div class="col-4">
				<a href="lola strapless rutched dress.jsp"> <img
					src="images/Lola strapless ruched dress.jpeg" alt="">
					<h4>
						<b>Lola Strapless Ruched Dress</b>
					</h4>
				</a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
