...
<%
	try{
		...
		ResultSet rs2 = st.executeQuery("Select * from product where ID = 9");
		while(rs2.next()){
%>
...
<body>
	...
	<!-- -----Single Product -->
<%
ResultSet rs = st.executeQuery("Select * from product where ID = 9");
while(rs.next()){
%>
...
%>
	...
	<div class="small-container">
		<div class="row row-2">
			...
			<a href="Products.jspindex.jsp">View More</a>
		</div>
	</div>
	...
	<div class="small-container">
		<div class="row">
			<div class="col-4">
				<a href=""><img src="images/Lola Abstract print pant set.jpeg"
					alt="">
					<h4>
						<b>Lola Abstract Print Pant Set</b>
					</h4></a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
				</div>
			...
			<div class="col-4">
				<a href=""> <img src="images/Lola Floral maxi romper.jpeg"
					alt="">
					<h4>
						<b>Lola Floral Maxi Romper</b>
					</h4>
				</a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
			...
			<div class="col-4">
				<a href=""><img src="images/Lola metallic v-neck dress.jpeg"
					alt="">
					<h4>
			...
			<div class="col-4">
				<a href=""><img src="images/Lola faux suede ruffle dress.jpeg"
					alt="">
					<h4>
