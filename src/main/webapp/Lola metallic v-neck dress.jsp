...
<%
	try{
		...
		ResultSet rs2 = st.executeQuery("Select * from product where ID = 11");
		while(rs2.next()){
%>
...
<body>
	...
	<!-- -----Single Product -->
<%
ResultSet rs = st.executeQuery("Select * from product where ID = 11");
while(rs.next()){
%>
		...
		<div class="row">
			<div class="col-4">
				<a href="Lola Abstract print pant set.jsp"> <img
					src="images/Lola Abstract print pant set.jpeg" alt="">
					<h4>
			...
			<div class="col-4">
				<a href="Lola Floral Maxi Romper.jsp"> <img
					src="images/Lola Floral maxi romper.jpeg" alt="">
					<h4>
