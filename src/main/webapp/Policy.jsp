...
<body>
	...
	<div class="small-container">
		<h2>RETURNS</h2>
		<div class="notes">
			<p>Our policy lasts 7 days. If 7 days have gone by since your purchase,
				unfortunately we cannot offer you a refund or exchange.</p>
				<br>
			<p>To be eligible for a return, your item must be 
				unused and in the same condition that you received it.
				It must also be in the original packaging.</p>
				<br>
			<p><b>There are certain situations where only partial refunds are granted (if applicable)</b> <br>
		...
		<div class="notes">
			...
			<p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from <a href="index.jsp" style="color: blue;">fashionhouseoflola.com</a></p>
			<br>
			...
			When you visit the Site, we automatically collect certain information about your device, including information about your web browser, IP address, time zone, and some of the cookies that are installed on your device. Additionally, as you browse the Site, we collect information about the individual web pages or products that you view, what websites or search terms referred you to the Site, and information about how you interact with the Site. We refer to this automatically collected information as "Device Information".</p>
				<br>
			<p><b>We collect Device Information using the following technologies:</b> <br>
- "Cookies" are data files that are placed on your device or computer and often include an anonymous unique identifier. For more information about cookies, and how to disable cookies, visit <a href="http://www.allaboutcookies.org" style="color: blues;">http://www.allaboutcookies.org</a>. <br>
...
Additionally when you make a purchase or attempt to make a purchase through the Site, we collect certain information from you, including your name, billing address, shipping address, payment information (including credit card numbers email address, and phone number. We refer to this information as "Order Information".  </p>
		...
		<br>
		<p><b>How do we use your personal information?</b> <br>
