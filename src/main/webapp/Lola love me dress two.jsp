...
<%
	try{
		...
		ResultSet rs2 = st.executeQuery("Select * from product where ID = 10");
		while(rs2.next()){
%>
...
<body>
	...
	<!-- -----Single Product -->
<%
ResultSet rs = st.executeQuery("Select * from product where ID = 10");
while(rs.next()){
%>
...
%>
	...
	<div class="small-container">
		<div class="row">
			<div class="col-4">
				<a href="Lola Love me dress one.html"> <img
			...
			<div class="col-4">
				<a href="Lola sassy mesh sleeve dress.html"> <img
					src="images/Lola sassy mesh sleeve dress.jpeg" alt="">
					<h4>
						<b>Lola Sassy Mesh Sleeve Dress </b>
					</h4></a>
				<div class="rating">
					<p>&#9733;&#9733;&#9733;&#9733;&#9734;</p>
				</div>
